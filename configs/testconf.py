...
cfg = Configurator(
        ...
        columns = {
            ...
            "bysample": {
                ...
                "TTbb_Hadronic": {"inclusive": [ColOut("events", outvars.NN_vars+outvars.bkg_vars)]},
                "TTbb_SemiLeptonic": {"inclusive": [ColOut("events", outvars.NN_vars+outvars.bkg_vars)]},
                "TTbb_2L2Nu": {"inclusive": [ColOut("events", outvars.NN_vars+outvars.bkg_vars)]},
                "TTToHadronic": {"inclusive": [ColOut("events", outvars.NN_vars+outvars.bkg_vars)]},
                "TTTo2L2Nu": {"inclusive": [ColOut("events", outvars.NN_vars+outvars.bkg_vars)]},
                "TTToSemiLeptonic": {"inclusive": [ColOut("events", outvars.NN_vars+outvars.bkg_vars)]},
            }
        }
        )
