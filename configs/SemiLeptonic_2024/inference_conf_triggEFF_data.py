...
import spanet_inference_trig
from spanet_inference_trig import ZHbbSpanetProcessor
...
cloudpickle.register_pickle_by_value(spanet_inference_trig)
...
cfg = Configurator(
        ...
        skim = [precut,
               ...
               #get_HLTsel_custom(['HLT_IsoMu24', 'HLT_Mu50', 'HLT_HighPtTkMu100', 'HLT_CascadeMu100'])],
               ],
        preselections = [get_JetVetoMap(), trig_event_selection, vetoE, vetoMu],
        categories = {
        ...
        columns = {
            "common": {
                "inclusive": [ColOut("events", outvars.common_vars+outvars.validation_vars+['sig_score', 'ttbb_score', 'ttlf_score']),
                              ColOut("HLT", outvars.trig_vars),
                        #ColOut(
                        #    "Parton",
