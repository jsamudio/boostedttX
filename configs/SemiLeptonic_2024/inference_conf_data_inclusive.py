...
from pocket_coffea.lib.cut_functions import get_nObj_min, get_HLTsel_custom, get_JetVetoMap, goldenJson
from pocket_coffea.parameters.histograms import *
import spanet_inference_inclusive
from spanet_inference_inclusive import ZHbbSpanetProcessor
...
cloudpickle.register_pickle_by_value(spanet_inference_inclusive)
...
cfg = Configurator(
        ...
        preselections = [get_JetVetoMap(), inc_event_selection, btag_mask, vetoE, vetoMu],
        ...
        columns = {
            "common": {
                "inclusive": [ColOut("events", outvars.validation_vars), #+outvars.weight_vars+['sig_score', 'ttbb_score', 'ttlf_score']),
                        #ColOut(
                        #    "Parton",
