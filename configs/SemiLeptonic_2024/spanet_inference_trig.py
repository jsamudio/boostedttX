...
from cand_helper_trig import zh_helper
...
class ZHbbSpanetProcessor (BaseProcessorABC):
    ...
    def process_extra_after_presel(self, variation):
        ...
        if 'DATA' not in self._sample:
            ...
            self.events['ele_trig_sf'], self.events['ele_trig_sfup'], self.events['ele_trig_sfdown'] = sf_ele_trigger(self.params, self.events, self._year)
