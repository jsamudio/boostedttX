...
class calc_ttbbXS:
    ...
    def get_ttBar(self):
        ...
        for i in ttBar:
            ...
            for j in filein['columns'][f'{i}'].keys():
                for var in pre_vars:
                    inner_list = filein['columns'][f'{i}'][f'{j}']['baseline']['nominal'][f'events_{var}'].value.tolist()
    ...
    def calc_ttbbXS(self):
        ...
        sum_signOf_genW = filein['sum_signOf_genweights']['TTtoLNu2Q_2024']
        #sum_signOf_genW = filein['sum_signOf_genweights']['TTto4Q_2024']
        #sum_signOf_genW = filein['sum_signOf_genweights']['TTto2L2Nu_2024']
        ...
        ttbbSum_signOf_genW = filein['sum_signOf_genweights']['TTBBtoLNu2Q_2024']
        #ttbbSum_signOf_genW = filein['sum_signOf_genweights']['TTBBto4Q_2024']
        #ttbbSum_signOf_genW = filein['sum_signOf_genweights']['TTBBto2L2Nu_2024']
