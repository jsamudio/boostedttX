...
def train_model(m_info):
    ...
    if __name__ == '__main__':
        ...
        # dont overwrite ~~~ !!!
        #exit()
        model.save_weights('./'+'/'+'newgenm_model'+'.h5')
        # ======= testing binary
...
if __name__ == "__main__":
    ...
    m_info = {'sequence': [['Dense', 128], ['Dense', 64], ['Dropout', 0.5]], 'other_settings': {'fl_a': [1, 1.5, 1], 'fl_g': 0.25, 'lr_alpha': 0.0001}, 'n_epochs': 150, 'batch_size': 10256}
