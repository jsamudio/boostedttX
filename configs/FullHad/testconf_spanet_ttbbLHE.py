...
import zhbbworkflow
from zhbbworkflow_spanet_ttbbLHE import ZHbbBaseProcessor
import outvars
...
cfg = Configurator(
        ...
        variables = {
            ...
            "LHE_HT" : HistConf([Axis(coll="LHE", field="HT", bins = 100, start=0, stop=1500, label=r"$H_{T}$ [GeV]")]),
        ...
        columns = {
            "common": {
                "inclusive": [ColOut("events", ["n_b_inZH", "bb_ht", "LHE_HT"]),
                        ColOut(
                            "Parton",
