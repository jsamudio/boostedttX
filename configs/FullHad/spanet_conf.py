...
import zhbbworkflow
from spanet_inference import ZHbbBaseProcessor
import outvars
        ...
        columns = {
            "common": {
                "inclusive": [#ColOut("events", ["newgenm_NN", "event"]+outvars.weight_vars),
                        ...
                        ColOut("FatJetSorted",["pt", "eta", "phi", "mass", "particleNetMD_Xbb"]),
                        ColOut(
                            "FatJetMatched",
                            ["pt", "eta", "phi", "particleNetMD_Xbb", "dRMatchedJet"],
                        ),
                        ColOut(
                            "HiggsMatched",
                            ["provenance", "dRMatchedJet"],
                        ),
                            ],
