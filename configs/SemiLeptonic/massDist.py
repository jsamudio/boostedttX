...
class DNN_datasets:
    ...
    def plot_dnnHist(self):
        ...
        fig.text(tex_x_corr,0.53, r'DNN score > 0.70', fontsize=10)
        ...
        plt.savefig("pdf/sl_mass200.pdf", bbox_inches='tight')
        #plt.savefig("pdf/sl_mass300.pdf", bbox_inches='tight')
        #plt.savefig("pdf/sl_mass450.pdf", bbox_inches='tight')
