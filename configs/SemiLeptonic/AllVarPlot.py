...
class DNN_datasets:
    ...
    def plot_dnnHist(self):
        ...
        for k in self.dnn_vars:

            fig, ax = plt.subplots()

            maximum = max(self.sb_df[f'{k}'])

            binning = np.arange(0, maximum+1 if maximum < 1000 else 1000, 0.1 if maximum < 1.5 else 1 if maximum <= 20 else 5 if maximum <= 100 else 20)
            ...
            for i in bkgs+sigs:
                ...
                if i in bkgs:
                    n, bins, patches = ax.hist(self.sb_df[f'{k}'][(self.sb_df['process'] == i)], bins=binning, stacked=False,
                    ...
                    n, bins, patches = ax.hist(self.sb_df[f'{k}'][(self.sb_df[genmatchreq] == True) & (self.sb_df['process'] == i)], bins=binning, stacked=False,
