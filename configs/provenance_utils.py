...
# This seems to rely on a very specific length of particle ids, will need to double check this
@njit
def get_partons_provenance_ttZbb(pdgIds, array_builder)
    """
    1 = Z boson
    ...
    for ids in pdgIds:
        ...
        if len(ids) in [6,7]:
            ...
            if hadr_top == -1
                # The antitop decayed hadronically
