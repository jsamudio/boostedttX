...
class DNN_datasets:
    ...
    def plot_dnnHist(self):
        ...
        fig.text(tex_x_corr,0.53, r'DNN score > 0.721', fontsize=10)
        ...
        plt.savefig("pdf/di_mass200.pdf", bbox_inches='tight')
        #plt.savefig("pdf/di_mass300.pdf", bbox_inches='tight')
        #plt.savefig("pdf/di_mass450.pdf", bbox_inches='tight')
